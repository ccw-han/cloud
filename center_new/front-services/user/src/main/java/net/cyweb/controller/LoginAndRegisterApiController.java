    ...
    public Result login(@ApiIgnore @Validated(value = {LoginValidateGroup.class}) YangMember yangMember, BindingResult bindingResult){
        ...
        try{
            ...
            if(bindingResult.hasErrors()){
                ...
                redisService.set(CoinConst.TOKENKEYMEMBER+loginMember.getMemberId().intValue(),token,86400l, TimeUnit.SECONDS);
                redisService.set(CoinConst.TOKENKEYTOKEN+token,loginMember.getMemberId(),86400l, TimeUnit.SECONDS);
