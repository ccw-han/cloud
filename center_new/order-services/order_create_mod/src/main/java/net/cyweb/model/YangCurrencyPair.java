...
public class YangCurrencyPair extends BaseEntity {
    ...
    public Integer getIsMidRobot() {
        return isMidRobot;
    }

    public void setIsMidRobot(Integer isMidRobot) {
        this.isMidRobot = isMidRobot;
    }

    public BigDecimal getCreateRate() {
        return createRate;
    }

    public void setCreateRate(BigDecimal createRate) {
        this.createRate = createRate;
    }

    public BigDecimal getGuaCreateRate() {
        return guaCreateRate;
    }

    public void setGuaCreateRate(BigDecimal guaCreateRate) {
        this.guaCreateRate = guaCreateRate;
    }

    public Double getShuaBlMin() {
        return shuaBlMin;
    }

    public void setShuaBlMin(Double shuaBlMin) {
        this.shuaBlMin = shuaBlMin;
    }
    ...
    public YangCurrencyPairExtendMidOrderJSON getYangCurrencyPairExtendMidOrder() {
        return yangCurrencyPairExtendMidOrder;
    }

    public void setYangCurrencyPairExtendMidOrder(YangCurrencyPairExtendMidOrderJSON yangCurrencyPairExtendMidOrder) {
        this.yangCurrencyPairExtendMidOrder = yangCurrencyPairExtendMidOrder;
    }
}