...
//    public void rebate(YangOrders yangOrdersBuy,YangOrders yangOrdersSell,BigDecimal loopTradeNum,BigDecimal buyerTradeFeeNum,BigDecimal sellerTradeFeePrice){
    ...
    public List<YangOrders> findRobotList(Map map){
        return yangOrdersMapper.findRobotList(map);
    }

    public int deleteBatch(List<YangOrders> list){
        return yangOrdersMapper.deleteBatch(list);
    }

   public Integer cancelOrder(Map queryMap){return yangOrdersMapper.cancelOrder(queryMap);}

   public List<YangOrders> findFinishOrderList(){
        return yangOrdersMapper.findFinishOrderList();
   }
