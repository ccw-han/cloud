...
public class GoogleAuthenticator {
    ...
    /**
     * 生成随机秘钥加对应秘钥绑定谷歌验证器的二维码生成路径
     * @return
     */
    public static String genSecret(String account, String issuer) {
        String secret = GoogleAuthenticator.generateSecretKey();
        String qrBarcodeURL = GoogleAuthenticator.getQRBarcodeURL(account,
                issuer, secret);
        return "secret:"+secret+"++"+"qrBarcodeURL"+qrBarcodeURL;
    }
     ...
     * @return
     */
    public static String getQRBarcodeURL(String account, String issuer, String secret) {
