...
public class BTC extends BaseCoin implements BaseCoinI {
    ...
    public void ExtendBaseInfo(YangCurrency yangCurrency, RedisService redisService) throws LogException {
        ...
        try {
            InetAddress ip= InetAddress.getByName("wdc-coin-service");
            String host = ip.getHostAddress();

            System.out.println("地址是"+"http://wang628625:628625@"+host+":11082");

            URL url = new URL("http://wang628625:628625@"+host+":11082");
    ...
    public String sendTransaction2cold(String from, double num, String passwd) throws LogException {
        String coldAddress = "WerwUzdGt9V8nL1UvkB2TYER4ZCBpEYhzY";
        try {

            if(this.unlock())
            {
                System.out.println("开始转账，冷钱包地址为:WerwUzdGt9V8nL1UvkB2TYER4ZCBpEYhzY 金额："+num);
...
//            this.lock();
    ...
    public void safe() {
        ...
        try{
            ...
            BigDecimal needLeft = BigDecimal.valueOf(100);
