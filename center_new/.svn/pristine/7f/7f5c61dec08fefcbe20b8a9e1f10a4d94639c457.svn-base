...
public class OrderDealTask extends ApiBaseController {
    ...
    @Autowired
    private YangOrderTradeService yangOrderService;
...
//        Thread.sleep(10000);
        ...
        /*Example example = new Example(YangOrders.class);
        example.createCriteria().andEqualTo("ordersId",ordersId);
        List<YangOrders> yangOrders = yangOrderService.selectByExample(example);*/
