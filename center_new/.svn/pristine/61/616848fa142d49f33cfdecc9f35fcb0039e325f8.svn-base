...
import net.cyweb.service.YangC2CAssetService;
...
public class AssetsApiController extends ApiBaseController {
     ...
     */
    /*用户所有资产*/
    @RequestMapping(value = "bibiAsset", method = RequestMethod.POST)
    @ApiOperation(value = "获取用户所有资产（币币）", notes = "获取用户所有资产（币币）")
    public Result bibiAsset(@RequestBody Map<String, String> map) {
        Result result = yangC2CAssetService.bibiAsset(map);
        return result;
    }
     ...
     */
    /*用户所有资产*/
    @RequestMapping(value = "fabiAsset", method = RequestMethod.POST)
    @ApiOperation(value = "获取用户指定资产（法币）", notes = "获取用户指定资产（法币）")
    public Result fabiAsset(@RequestBody Map<String, String> map) {
        Result result = yangC2CAssetService.fabiAsset(map);
        return result;
    }
     ...
     */
    /*用户所有资产*/
    @RequestMapping(value = "allAsset", method = RequestMethod.POST)
    @ApiOperation(value = "获取用户总资产（法币+币币）", notes = "获取用户总资产（法币+币币）")
    public Result allAsset(@RequestBody Map<String, String> map) {
        ...
        result = yangC2CAssetService.allAsset(map);
        return result;
    }
