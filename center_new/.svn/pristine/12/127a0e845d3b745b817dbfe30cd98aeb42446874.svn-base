...
import utils.collectUtils.Collect;
import utils.collectUtils.CollecterBase;
        ...
        public boolean doCollect() throws Exception
        {
            ...
            try {
                ...
                Document doc = Jsoup.connect(url)
                        ...
                        .timeout(6000)
                        .get();
                Elements price = doc.select(".mainPrice .convert"); //带有href属性的a元素
                ...
                System.out.println("采集的价格为"+ BigDecimal.valueOf(Double.valueOf(prices)));
                return false;
            }catch (Exception e)
            {
                e.printStackTrace();
