...
public class YangCurrencyPair extends BaseEntity {
    ...
    @Column(name = "is_show_first_desk")
    private  String isShowFirstDesk;
    /**
     * @return cy_id
     */
    ...
    public String getIsShowFirstDesk() { return isShowFirstDesk;}

    public void setIsShowFirstDesk(String isShowFirstDesk) {this.isShowFirstDesk = isShowFirstDesk;}
}