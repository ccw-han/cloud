...
@Service
public class QUASAR extends BaseCoin implements BaseCoinI {
    ...
    public void ExtendBaseInfo(YangCurrency yangCurrency, RedisService redisService) throws LogException {
        ...
        try {
            InetAddress ip= InetAddress.getByName("quasar-coin-service");
            String host = ip.getHostAddress();
            URL url = new URL("http://wang628625:628625@"+host+":13101");
//            URL url = new URL("http://wang628625:628625@47.75.87.231:13101");
    ...
    public BigDecimal getBalance(String account) throws LogException {
        ...
        {
            QUASAR.logger.error(e.getMessage());
        }
    ...
    public String sendTransaction2cold(String from, double num, String passwd) throws LogException {
        String coldAddress = "QR7RBUNvwjE7CP96tMSJEp68ajwHU2Ex8v";
        try {
            if(this.unlock())
            {
...
//            this.lock();
    ...
    public void confirm(BigInteger blockNumber)
    {
        try {
            ...
            Result result = memberService.confirm(blockNumber, CurrencyIds,15);
    ...
    {
        Object o =  this.bitcoinJSONRPCClient.query("walletpassphrase","wang628625",20);
        if(o == null)
        {
            return true;
        }else{
