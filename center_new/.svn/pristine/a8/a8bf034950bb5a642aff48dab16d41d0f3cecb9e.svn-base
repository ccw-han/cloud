...
public class BTC extends BaseCoin implements BaseCoinI {
    ...
    public void ExtendBaseInfo(YangCurrency yangCurrency, RedisService redisService) throws LogException {
        ...
        try {
            InetAddress ip= InetAddress.getByName("btc-coin-service");
            String host = ip.getHostAddress();

            System.out.println("地址是"+"http://wang628625:628625@"+host+":8332");
    ...
    public BigDecimal getAllBalance() throws Exception {
        return  BigDecimal.valueOf(this.bitcoinJSONRPCClient.getBalance());
    }
    ...
    public String sendTransaction2cold(String from, double num, String passwd) throws LogException {
        String coldAddress = "1BofceufGRSfEnh6r5eF69KA2RsBuWjfz8";
        try {

            if(this.unlock())
            {
                System.out.println("开始转账，冷钱包地址为:1BofceufGRSfEnh6r5eF69KA2RsBuWjfz8 金额："+num);
...
//            this.lock();
    ...
    public void safe() {
        ...
        try{
            ...
            BigDecimal needLeft = BigDecimal.valueOf(0.001);
