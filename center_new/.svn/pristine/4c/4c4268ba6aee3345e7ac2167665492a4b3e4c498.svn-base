...
public class YangCurrency extends BaseEntity {
    ...
    @Column(name = "is_buycointomoney")
    private String isBuycointomoney;

    @Column(name = "father_cy_mark")
    private String fatherCyMark;

    public String getIsBuycointomoney() {
        return isBuycointomoney;
    }

    public void setIsBuycointomoney(String isBuycointomoney) {
        this.isBuycointomoney = isBuycointomoney;
    }

    public String getFatherCyMark() {
        return fatherCyMark;
    }

    public void setFatherCyMark(String fatherCyMark) {
        this.fatherCyMark = fatherCyMark;
    }
